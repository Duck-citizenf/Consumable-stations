...
{
	public class HeartLantern : ModItem
	{
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Gives a Heart Lamp buff");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.buffType = BuffID.HeartLamp; //Specify an existing buff to be applied when used.
