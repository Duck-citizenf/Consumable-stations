...
{
	public class StarinaBottle : ModItem
	{
        public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Star in a Bottle");
            Tooltip.SetDefault("Gives a Star in a Bottle buff");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.buffType = BuffID.StarInBottle; //Specify an existing buff to be applied when used.
